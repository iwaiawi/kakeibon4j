...
public interface AuthorizationClient extends java.io.Serializable {
	
	public AuthorizationContext getContext() throws KakeibonException;
	
	public AuthorizationContext login() throws KakeibonException;
	
	public void logout() throws KakeibonException;
